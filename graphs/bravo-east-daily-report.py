...
chart.title = 'Bravo East AE1 - % Failure Rate by Hour and Zone - Last 30 Days'

chart.add('bravo-AE1-az1', az1_data)
chart.add('bravo-AE1-az2', az2_data)
chart.add('bravo-AE1-az3', az3_data)

chart.render_to_file('bravo-east-failure-rate-by-hour.svg')
chart.render_to_png('bravo-east-failure-rate-by-hour.png')
...
chart.title = 'Bravo East AE1 - % Failure Rate by Day - Last 90 Days'

chart.add('bravo-AE1-az1', az1_data)
chart.add('bravo-AE1-az2', az2_data)
chart.add('bravo-AE1-az3', az3_data)

chart.render_to_file('bravo-east-failure-rate-by-day.svg')
chart.render_to_png('bravo-east-failure-rate-by-day.png')
